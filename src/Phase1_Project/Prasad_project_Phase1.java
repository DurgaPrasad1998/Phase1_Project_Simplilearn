...
public class Prasad_project_Phase1 { 
public static void main(String[] args) { 
// TODO Auto-generated method stub 
   String filename; 
    char ch; 
File directory = new  File("C:\\Users\\krish\\OneDrive\\Pictures\\Screenshots\\Phase1_Project\\"); 
String[] flist = directory.list(); 
// Take user Option from the below mentioned Menu 
Scanner input = new Scanner(System.in); 
        System.out.println("*****************************************"); 
        System.out.println("********Simplilearn Phase1_Project*******"); 
        System.out.println("*****************************************"); 
  ...
  switch (choice) { 
   case 1: 
        System.out.println("Enter the file name for creating  new file"); 
         filename = input.next(); 
   try { 
 File file = new  File("C:\\Users\\krish\\OneDrive\\Pictures\\Screenshots\\Phase1_Project\\" + filename + ".txt");
...
filename = input.next(); 
File directory_delete = new  File("C:\\Users\\krish\\OneDrive\\Pictures\\Screenshots\\Phase1_Project\\"); 
...
File file = new File("C:\\Users\\krish\\OneDrive\\Pictures\\Screenshots\\Phase1_Project\\" + delete_filename); 
    if (file.delete()) { 
...
filename = input.next(); 
File directory_search = new File("C:\\Users\\krish\\OneDrive\\Pictures\\Screenshots\\Phase1_Project\\");
...
File folder = new File("C:\\Users\\krish\\OneDrive\\Pictures\\Screenshots\\Phase1_Project\\"); 
